/**
 * Threads — React Bits (@react-bits/Threads-TS-TW), https://reactbits.dev
 *
 ...
 * unmodified: it already caps render resolution and pauses when offscreen
 * or backgrounded, which is exactly what this app needs.
 *
 * Chosen as the workhorse background because it renders to a transparent
 * canvas and takes its colour as a uniform — so one component serves both
 * the light and dark themes by being handed a different colour, instead of
 * needing a second dark-only asset.
 *
